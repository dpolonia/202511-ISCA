...
const ApresentacaoDanielPolonia = () => {
        ...
        <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <div className="max-w-4xl">
            <p className="text-3xl text-blue-900 font-light leading-relaxed">
              ...
              <span className="font-semibold">experiência profissional e excelência pedagógica</span><br/>
        ...
        <div className="h-full flex flex-col p-16">
          ...
          <div className="flex-1 flex flex-col justify-center space-y-10">
            ...
            <div className="border-l-4 border-green-500 pl-8">
              ...
              <p className="text-xl text-gray-700 leading-relaxed">
                Docente DEGEIT • Direção Mestrado Gestão • 
                Investigação IT Saúde (GOVCOPP) • ANI Consultor Sénior
              </p>
            </div>
        ...
        <div className="h-full flex flex-col p-16">
          ...
          <div className="grid grid-cols-2 gap-12 mb-10">
            ...
            <div className="bg-blue-50 rounded-xl p-8">
              <h3 className="text-2xl font-semibold text-blue-900 mb-6">Métricas Scopus</h3>
            ...
            <div className="bg-green-50 rounded-xl p-8">
              <h3 className="text-2xl font-semibold text-green-900 mb-6">Distribuição Temática</h3>
              <div className="space-y-4">
                <div>
          ...
          <div className="bg-gray-50 rounded-xl p-8">
            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Top 3 Trabalhos Mais Citados</h3>
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">J Business Ethics (Q1), 2017 • <span className="font-semibold text-blue-600">82 citações</span></p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">J Open Innovation, 2021 • <span className="font-semibold text-blue-600">17 citações</span></p>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">J Technology Management, 2019 • <span className="font-semibold text-blue-600">10 citações</span></p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="h-full flex flex-col p-16">
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="bg-yellow-50 rounded-xl p-8">
              <h3 className="text-3xl font-semibold text-yellow-900 mb-6">Avaliações P29</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-xl text-gray-700">Média:</span>
                  <span className="text-5xl font-bold text-yellow-600">6.8<span className="text-3xl">/9</span></span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-xl text-gray-700">Máxima:</span>
                  <span className="text-4xl font-bold text-yellow-600">8.22<span className="text-2xl">/9</span></span>
                </div>
                <p className="text-lg text-gray-600 mt-4">Múltiplas avaliações <span className="font-semibold">&gt;7.0</span></p>
              </div>
            </div>

            {/* Diversidade */}
            <div className="bg-blue-50 rounded-xl p-8">
              <h3 className="text-3xl font-semibold text-blue-900 mb-6">Diversidade</h3>
              <div className="space-y-4">
                <div>
                  <h4 className="text-lg font-semibold text-gray-800 mb-2">Departamentos</h4>
                  <p className="text-lg text-gray-700">DEGEIT • ESTGA • ESAN • ESSUA</p>
                </div>
                <div>
                  <h4 className="text-lg font-semibold text-gray-800 mb-2">Públicos</h4>
                  <p className="text-lg text-gray-700">Gestão • Engenharias • Saúde</p>
                </div>
                <div>
                  <h4 className="text-lg font-semibold text-gray-800 mb-2">Orientações</h4>
      ...
      content: (
        <div className="h-full flex flex-col p-16">
          ...
          <div className="grid grid-cols-2 gap-8">
            {/* Dimensão */}
            <div className="bg-blue-50 rounded-xl p-8">
              <h4 className="text-3xl font-semibold text-blue-900 mb-6">Dimensão</h4>
              <div className="space-y-4">
                <div className="flex items-center">
                  <span className="text-6xl font-bold text-blue-600 mr-4">~300</span>
                  <span className="text-2xl text-gray-700">alunos<br/>coordenados</span>
                </div>
                <div className="flex items-center">
                  <span className="text-6xl font-bold text-blue-600 mr-4">6</span>
                  <span className="text-2xl text-gray-700">UCs integradas<br/>simultâneas</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-green-50 rounded-xl p-6">
                <h4 className="text-2xl font-semibold text-green-900 mb-4">UCs Integradas</h4>
              ...
              <div className="bg-purple-50 rounded-xl p-6">
                <h4 className="text-2xl font-semibold text-purple-900 mb-4">Coordenação Complexa</h4>
          ...
          <div className="mt-8 bg-gray-100 rounded-xl p-6 text-center">
            <p className="text-2xl text-gray-700">
              <span className="font-semibold text-gray-900">Demonstra:</span> Liderança pedagógica • Visão estratégica • 
              Transformação digital ensino à escala
            </p>
          </div>
        </div>
      )
      ...
      content: (
        <div className="h-full flex flex-col p-16">
          ...
          <div className="grid grid-cols-2 gap-8 mb-6">
            ...
            <div className="bg-blue-50 rounded-xl p-6 border-l-4 border-blue-600">
              ...
              <div className="space-y-2 text-gray-700">
                <p><span className="font-semibold">Papel:</span> Gestor projeto parceiro UA</p>
                <p><span className="font-semibold">Orçamento:</span> €790.941 total | €56.667 UA</p>
                <p className="text-sm mt-3">Novo modelo hospital baseado inovação/transferência conhecimento</p>
            ...
            <div className="bg-green-50 rounded-xl p-6 border-l-4 border-green-600">
              ...
              <p className="text-sm text-gray-600 mb-4">2013-2015 • Electronic Marketplace TeleRadiology</p>
              <div className="space-y-2 text-gray-700">
                <p><span className="font-semibold">Papel:</span> Coordenador equipa UA + IUZ</p>
                <p><span className="font-semibold">Orçamento:</span> €311.866 total | €21.683 UA</p>
                <p className="text-sm mt-3">Plataforma marketplace digital serviços radiologia</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            {/* Projetos Europeus */}
            <div className="bg-purple-50 rounded-xl p-6">
              <h4 className="text-xl font-semibold text-purple-900 mb-4">Projetos Europeus</h4>
              <ul className="space-y-2 text-sm text-gray-700">
                <li><span className="font-semibold">HELIUM</span> (CE, 2016-18)<br/>Coordenador ANI</li>
                <li><span className="font-semibold">EEN</span> (CE, 2015-18)<br/>Coordenador ANI</li>
                <li><span className="font-semibold">InfoBioMed</span> (CE, 2004-07)</li>
              </ul>
            </div>
            ...
            <div className="bg-teal-50 rounded-xl p-6">
              <h4 className="text-xl font-semibold text-teal-900 mb-4">Transferência Sociedade</h4>
              <ul className="space-y-2 text-sm text-gray-700">
                <li><span className="font-semibold">IUZ/PNPSO</span> (2010-11)<br/>Coordenador • €14.983</li>
                <li><span className="font-semibold">ERS</span> (2011)<br/>Consultoria • €7.945</li>
              </ul>
            </div>
          </div>
      ...
      content: (
        <div className="h-full flex flex-col p-16">
          <div className="bg-blue-600 text-white rounded-t-2xl p-6 -mx-16 -mt-16 mb-10">
            ...
            <p className="text-2xl mt-2 opacity-90">EHDS e Value-Based Healthcare na Era da IA</p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-blue-50 rounded-xl p-6 border-l-4 border-blue-600">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                Interoperabilidade sistemas saúde europeus • 
                Modelos governação dados transfronteiriços
              </p>
            </div>
            ...
            <div className="bg-green-50 rounded-xl p-6 border-l-4 border-green-600">
              <h3 className="text-2xl font-semibold text-green-900 mb-3">
                Linha 2: IA e Analytics para VBHC
              </h3>
              <p className="text-lg text-gray-700 leading-relaxed">
                Modelos gestão saúde baseados dados/IA • 
                Sistemas suporte decisão clínica multi-fonte • 
                ML para análise outcomes e redução custos
              </p>
            </div>
            ...
            <div className="bg-purple-50 rounded-xl p-6 border-l-4 border-purple-600">
              <h3 className="text-2xl font-semibold text-purple-900 mb-3">
                Linha 3: Ética e Segurança Dados Saúde
              </h3>
              <p className="text-lg text-gray-700 leading-relaxed">
                Implicações éticas/jurídicas tecnologias saúde • 
                Privacidade e segurança plataformas digitais • 
                RGPD aplicado a EHDS
              </p>
            </div>
          </div>

          <div className="mt-8 bg-gray-100 rounded-xl p-6">
            <h4 className="text-2xl font-semibold text-gray-900 mb-4">Outputs Previstos (5 anos)</h4>
            <div className="grid grid-cols-2 gap-6">
              <div>
                <p className="text-lg text-gray-700">
                  <span className="font-semibold text-blue-600">3-5 publicações Q1/Q2</span>
                </p>
                <p className="text-sm text-gray-600 mt-2">
                  J Medical Internet Research • Int J Medical Informatics • BMC Medical Informatics
                </p>
              </div>
              <div>
                <p className="text-lg text-gray-700">
                  <span className="font-semibold text-green-600">2-3 projetos europeus</span>
                </p>
                <p className="text-sm text-gray-600 mt-2">
                  Horizon Europe • Interreg Europe
                </p>
              </div>
            </div>
          </div>
      ...
      content: (
        <div className="h-full flex flex-col p-16">
          <div className="bg-green-600 text-white rounded-t-2xl p-6 -mx-16 -mt-16 mb-10">
            <h2 className="text-5xl font-bold">PILAR 2: Ensino</h2>
            <p className="text-2xl mt-2 opacity-90">Preparar Profissionais SI para a Era da IA</p>
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-green-50 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-green-900 mb-4">
                  1. UC Nova: "IA e Analytics em SI"
                </h3>
                <ul className="space-y-2 text-gray-700">
                  <li>• IA generativa (ChatGPT, Claude)</li>
                  <li>• ML aplicado a BI</li>
                  <li>• Ética e governança IA</li>
                  <li>• <span className="font-semibold">Vibe Coding + PBL</span></li>
                </ul>
              </div>
      ...
      content: (
        <div className="h-full flex flex-col p-16">
          ...
          <div className="grid grid-cols-3 gap-6 mb-8">
            {/* Parcerias */}
            <div className="bg-blue-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-blue-900 mb-4">Instituições Saúde</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• ACSS/SPMS</li>
                <li>• ULSRA</li>
            ...
            <div className="bg-green-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-green-900 mb-4">Empresas Tech</h3>
              <ul className="space-y-2 text-sm text-gray-700">
            ...
            <div className="bg-orange-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-orange-900 mb-4">Entidades Públicas</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li>• DGS</li>
                <li>• SPMS</li>
                <li>• ERS</li>
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl p-5">
              ...
              <p className="text-sm">Apoio 2 instituições preparação EHDS • Formação literacia dados • Dashboard VBHC</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl p-5">
              ...
              <p className="text-sm">Plataforma-piloto integração dados VBHC • Consultoria sistemas • Guia boas práticas</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl p-5">
              ...
              <p className="text-sm">ISCA referência nacional Digital Health Systems • Rede parcerias consolidada</p>
            </div>
          </div>

          <div className="mt-6 bg-gray-100 rounded-xl p-4">
            <p className="text-lg text-gray-700 text-center">
              <span className="font-semibold text-gray-900">Transversal:</span> 
              2-3 orientações doutoramento • Linha investigação • Recrutamento investigadores júniores
            </p>
          </div>
        </div>
      )
            ...
            {slides.map((_, idx) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all ${
                  idx === currentSlide ? 'bg-blue-400 w-8' : 'bg-gray-600 hover:bg-gray-500'
                }`}
              />
            ))}
          </div>
...
export default ApresentacaoDanielPolonia;
